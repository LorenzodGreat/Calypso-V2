    ...
    >
      ...
      <Carousel.Slide ><div className='relative'>
        ...
        <div className='absolute md:flex lg:flex top-20 left-8 md:top-[4rem] md:left-[9rem] lg:top-[4rem] lg:left-[9rem]'>
          <div className='w-[35vh] sm:w-[80vh] lg:w-[80vh] md:w-[80vh] space-y-4'>
            <div>
            ...
            <div className='flex lg:space-x-8 md:space-x-8 sm:space-x-8 space-x-4'>
              ...
              <button className='text-white font-semibold w-[10vh] sm:w-[50vh] md:w-[50vh] lg:w-[50vh] text-[0.5rem] sm:text-base md:text-base lg:text-base hover:scale-125 transition-all duration-300 md:px-4 md:py-2 sm:px-4 sm:py-2 lg:px-4 lg:py-2 rounded-full border ring ring-[#8010f8]'><a href="https://cal.tasoko.com/register">Register Now</a></button>
            </div>
          </div>
        </div>
      </div>
      ...
      <Carousel.Slide ><div className='relative'>
        ...
        <div className='absolute md:flex lg:flex top-20 left-8 md:top-[4rem] md:left-[9rem] lg:top-[16rem] lg:left-[9rem]'>
          <div className='w-[25vh] sm:w-[80vh] lg:w-[80vh] md:w-[80vh] space-y-4'>
            ...
            <div className='flex lg:space-x-8 pt-4 md:space-x-8 sm:space-x-8 space-x-4'>
