  ...
  return (
    <section class="bg-white dark:bg-gray-900">
      <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form class="w-full max-w-md" onSubmit={handleRegister}>
          ...
          <div class="flex items-center justify-center mt-6">
            ...
            <a href="/register" class="w-1/3 pb-4 font-medium text-center text-gray-800 capitalize border-b-2 border-blue-500 dark:border-blue-400 dark:text-white">
              sign up
            </a>
          </div>
          ...
          {errors.name &&
            <p className='py-2 text-sm text-gray-600 dark:text-gray-200'>{errors.name[0]}</p>
          }
