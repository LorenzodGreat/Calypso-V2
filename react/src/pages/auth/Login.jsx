    ...
    <>
      ...
      <section class=" dark:bg-[#290658]">
        <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
          <form class="w-full max-w-md" onSubmit={handleLogin}>
            <div class="flex justify-center mx-auto">
              <a href="/">
                <img class="w-auto h-7 sm:h-20" src={CalypsoLogo} alt="Calypso Logo" />
              </a>
            </div>

            <div class="flex items-center justify-center mt-6">
              <a href="/login" class="w-1/3 pb-4 font-medium text-center text-gray-800 capitalize border-b-2 border-blue-500 dark:border-blue-400 dark:text-white">
                sign in
              </a>

              {/* <a href="/register" class="w-1/3 pb-4 font-medium text-center text-gray-500 capitalize border-b dark:border-gray-400 dark:text-gray-300">
              sign up
            </a> */}
            </div>
            ...
            <div class="mt-6">
              ...
              <div class="mt-6 text-center ">
                <div class="flex items-center justify-between my-4">
                  <a href="/admin-portal/forgot-password" class="text-sm text-gray-600 dark:text-gray-200 hover:text-gray-500">Forget Password?</a>
