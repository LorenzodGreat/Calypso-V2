...
import Question from '../../img/service/question.jpg';
    ...
    return (<>
        {
            loading
                ...
                <div className=''>
                    <MainNav />
                    <div className=' space-y-1 py-16 md:py-16 lg:py-16'>
                        <div className="relative shadow-md border-1 border-b-2 border-grey-100 bg-indigo-800">
