...
const Rate = () => {
    ...
    useEffect(() => {
        ...
        if (weightCost >= 100) { setItemCost('Please Contact Us') }
    }, [weightCost])
    ...
    return (
        <>
            <MainNav />
            <div className='pt-28 px-6 bg-[#270657]'>
                <p class="text-xl font-medium text-blue-500 ">Calypso Rate Calculator</p>
                <h1 class="mt-2 text-2xl font-semibold text-gray-50 capitalize lg:text-3xl">Always Stay Alert Never miss out on the latest news today</h1>
            </div>
            <section className="w-full sm:px-6 lg:px-8 p-4 lg:flex space-y-4 flex-1 h-full bg-[#270657]">
                <div className="relative mx-auto sm:py-16">
                                ...
                                <div className="mt-6 sm:mx-auto sm:max-w-lg">
                                    <div className="mt-1 relative rounded-md shadow-sm">
                                        <input
                                            ...
                                            placeholder="Estimated Weight Here"
                                            maxLength={4}
