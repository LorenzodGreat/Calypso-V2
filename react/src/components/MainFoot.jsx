const navigation = {
  ...
  social: [
    ...
    },
    {
      ...
      icon: (props) => (
        <i class="fa-brands h-4 fa-whatsapp -mt-1 text-2xl"></i>
      ),
    },
    // {
    //   name: 'GitHub',
...
export default function MainFoot() {
  return (
    <footer className="bg-[#270657]">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          {navigation.main.map((item) => (
            <div key={item.name} className="px-5 py-2">
              <a href={item.href} className="text-lg text-gray-500 hover:text-gray-50">
                {item.name}
              </a>
            </div>
          ))}
        ...
        <p className="mt-8 text-center text-base text-gray-400">&copy; 2022 CalypsoShipping, Inc. All rights reserved.</p>
      </div>
    </footer>
  )
}
